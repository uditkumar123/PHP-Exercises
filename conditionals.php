...
$message = $redLight ? "Stop the car!" : "Go!";
echo "<p>$message</p>";
...
if ($greenLight === false && $redLight === true || $yellowLight === true) {
    echo "Stop the car!";
} else if ($greenLight === false && $redLight === false && $yellowLight === false) {
    echo "Power outage!";
...
switch(true) {
case ($greenLight === false && $redLight === true || $yellowLight === true):
    echo "Stop the car!";
    break;
